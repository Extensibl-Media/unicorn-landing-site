  ...
  return (
    <TabsPrimitive
      ...
      onValueChange={(newTab) =>
        updateSearchParams(newTab, undefined, undefined, 0)
      }
    >
      <TabsList>
      ...
      <TabsContent value={activeTab} className="mt-6">
        <UsersTable
          ...
          status={status}
          onSearch={(search) =>
            updateSearchParams(undefined, search, undefined, 0)
          }
          onStatusChange={(newStatus) =>
            updateSearchParams(undefined, undefined, newStatus, 0)
          }
          onPageChange={(page) =>
            updateSearchParams(undefined, undefined, undefined, page)
          }
        />
      </TabsContent>
    </TabsPrimitive>
